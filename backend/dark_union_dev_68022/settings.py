"""
Django settings for dark_union_dev_68022 project.
...
ROOT_URLCONF = 'dark_union_dev_68022.urls'
...
WSGI_APPLICATION = 'dark_union_dev_68022.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dark_union_dev_68022 API",
    "DESCRIPTION": "API documentation for dark_union_dev_68022 App",
    "VERSION": "v1",
}
